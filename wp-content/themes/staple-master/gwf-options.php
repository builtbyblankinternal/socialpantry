...
body { font-family:
<?php echo get_option('_body_font'); ?>; }

h1, h2, h3, h4, h5, h6, blockquote, .main-navigation a, .footer-menu li a, .link-button { font-family:
<?php echo get_option('_headline_font'); ?>
!important; }

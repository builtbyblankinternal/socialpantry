...
function theme_options_add_page() {
	add_menu_page( __( 'Social Icons', 'sampletheme' ), __( 'Social Icons', 'sampletheme' ), 'edit_theme_options', 'theme_options', 'theme_options_do_page', 'dashicons-admin-generic',81 );
}
/**
...
function theme_options_do_page() {
	...
	?>
	<div class="wrap">
		<?php screen_icon(); echo "<h2>" . __( 'Social Pantry', 'sampletheme' ) . __( ' Theme Options', 'sampletheme' ) . "</h2>"; ?>
...
function theme_options_validate( $input ) {
	...
	$input['collaborate_title'] = ( $input['collaborate_title'] );
	$input['collaborate_sub_title'] = ( $input['collaborate_sub_title'] );
	$input['collaborate_url'] = ( $input['collaborate_url'] );
